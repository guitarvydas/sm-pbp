...
rmspan {
  ...
  str = "\"" schar* "\""
  schar =
    | "&lt;span" (~endbeginspan any)+ endbeginspan spancontent espan -- span
    | (~"\"" any) -- other
  spancontent = (~espan any)+
  espan = "&lt;/span&gt;"
  endbeginspan= "&quot;&gt;"
}
`;
...
schar_span : function (_begin,_stuff,_endbegin,content,_end,) {
enter_rule ("schar_span");
    set_return (`${content.rwr ()}`);
return exit_rule ("schar_span");
},
spancontent : function (cs,) {
enter_rule ("spancontent");
    set_return (`${cs.rwr ().join ('')}`);
return exit_rule ("spancontent");
},
espan : function (s,) {
enter_rule ("espan");
    set_return (``);
return exit_rule ("espan");
},
endbeginspan : function (s,) {
enter_rule ("endbeginspan");
    set_return (``);
return exit_rule ("endbeginspan");
},
